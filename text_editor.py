...
''')
while True :
    actionchoice = List("choice",message='what would you like to do?',choices=["add some text","read the file","destroy the file",'close the program','encrypt the file','decrypt the file'])
